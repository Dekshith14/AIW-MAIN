          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <AnimatedSection>
              ...
              <h2 className="text-headline mt-3 mb-6">
                Building Spaces Since 2013
              </h2>
              <div className="space-y-6 text-muted-foreground leading-relaxed">
                <p>
                  Founded in 2013, AIW is a dynamic specialist organization delivering
                  services across multiple domains. We bring together broad-minded
                  professionals from diverse disciplines and encourage them to think
                  beyond their specialization, driving innovation and excellence.
                </p>
                <p>
                  We maintain a strong competitive edge through efficiency, flexibility,
                  and an unwavering commitment to quality. Our primary focus is on
                  delivering high-quality, cost-effective services that comply with both
                  local and international standards while remaining deeply respectful of
                  the environment.
                </p>
                <p>
                  Today, AIW continues to achieve steady growth and proudly employs
                  nearly 50 skilled professionals. With offices in Tamil Nadu and
                  Telangana, our strong resource base ensures capacity and expertise to
                  deliver projects on time while meeting the highest quality standards.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2} direction="right">
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-accent text-accent-foreground p-6">
                  <p className="font-serif text-lg">Since 2013</p>
                  <p className="text-xs uppercase tracking-widest mt-1 opacity-80">
                    Interior Contractor of Choice
                  </p>
                </div>
              </div>
            </AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <AnimatedSection className="bg-card p-10 md:p-12">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                through competent, timely, and cost-effective solutions. We
                envision a world where every built environment enhances the lives
            ...
            <AnimatedSection delay={0.15} className="bg-card p-10 md:p-12">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To deliver high-quality, cost-effective services that comply with
                both local and international standards while remaining deeply
                respectful of the environment and prioritizing the health and
